...
public class SizeUtils {
     ...
     * @return 视图高度
     */
    public static ViewGroup.LayoutParams setViewMargin(View view, boolean isDp, float left, float right, float top, float bottom) {
        if(null == view) {
            return null;
        }
